...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook with the provided 'Name', 'Type', and 'Weighted' status. Type can be Standard or Ranked, Weighted (true or false)");
            Console.WriteLine();
